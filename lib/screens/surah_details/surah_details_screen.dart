...
import 'package:international_Quran/screens/surah_details/reading_screen.dart';
import 'package:international_Quran/screens/surah_details/translation_screen.dart';
  ...
  Widget get buildBody {
    return Padding(
      padding: EdgeInsets.only(
          top: context.watch<SurahDetailsProvider>().readingSettings.isReadingMode
              // && Platform.isIOS
              ? 40 :
          0),
      child: Column(
