...
import 'package:international_Quran/screens/search_result_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  SurahList buildToggleSearchPages(BuildContext context) {
    return SurahList(onTap: (surahId) {
      context.read<SearchProvider>().goToSurah(context, surahId, true);
    });
  }

  /// off for now ----- Juz/Translation and Search pages
  FadeIndexedStack buildToggleSearchPages0(BuildContext context) {
